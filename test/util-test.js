...
describe("sha256hash", function() {
  ...
  it("correctly handles unicode", function() {
    ...
    assert.equal(
      hash,
      "67e714147fe88f73b000da2f0447d16083801ba3ac9c31f607cf8cbaf994aa09"
    );
  });
  ...
  it("correctly handles binary data", function() {
    ...
    assert.equal(
      hash,
      "46e9b4475a55f86f185cc978fdaef90d4a2ef6ba66d77cecb8763a60999a41c3"
    );
  });
});
...
describe("base64encode", function() {
  ...
  it("correctly handles unicode", function() {
    assert.equal(
      utils.base64encode("I ♡ \nJavaScript!"),
      "SSDimaEgCkphdmFTY3JpcHQh"
    );
  });
